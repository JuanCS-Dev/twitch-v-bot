...
PARITY_CONTRACT: tuple[ParityContractEntry, ...] = (
    ...
    ParityContractEntry(
        method="GET",
        backend_route="/api/semantic-memory",
        domain="prompt_runtime",
        dashboard_surface="intelligence_panel",
        status="integrated",
        dashboard_route_prefix="/api/semantic-memory",
        backend_test_files=(
            "bot/tests/test_dashboard_routes.py",
            "bot/tests/test_dashboard_routes_v3.py",
        ),
        ...
        route_snippet="/api/semantic-memory",
    ),
    ParityContractEntry(
        method="PUT",
        backend_route="/api/semantic-memory",
    ...
    ParityContractEntry(
        method="GET",
        backend_route="/api/ops-playbooks",
        domain="control_plane",
        dashboard_surface="risk_queue_panel",
        status="integrated",
        dashboard_route_prefix="/api/ops-playbooks",
        backend_test_files=(
            "bot/tests/test_dashboard_routes.py",
            "bot/tests/test_dashboard_routes_v3.py",
        ),
        dashboard_test_files=("dashboard/tests/api_contract_parity.test.js",),
        route_snippet="/api/ops-playbooks",
    ),
    ParityContractEntry(
        method="POST",
        backend_route="/api/ops-playbooks/trigger",
        domain="control_plane",
        dashboard_surface="risk_queue_panel",
        status="integrated",
        dashboard_route_prefix="/api/ops-playbooks/trigger",
        backend_test_files=(
            "bot/tests/test_dashboard_routes_post.py",
            "bot/tests/test_dashboard_routes_v3.py",
        ),
        dashboard_test_files=("dashboard/tests/api_contract_parity.test.js",),
        route_snippet="/api/ops-playbooks/trigger",
    ),
    ParityContractEntry(
        method="POST",
    ...
    ParityContractEntry(
        ...
        domain="observability",
        dashboard_surface="metrics_health + intelligence_panel + agent_context_internals",
        status="integrated",
        dashboard_route_prefix="/api/sentiment/scores",
        backend_test_files=("bot/tests/test_dashboard_routes_v3.py",),
        dashboard_test_files=(
            "dashboard/tests/api_contract_parity.test.js",
            "dashboard/tests/multi_channel_focus.test.js",
    ...
    ParityContractEntry(
        ...
        domain="clips",
        dashboard_surface="clips_section",
        status="integrated",
        dashboard_route_prefix="/api/vision/status",
        backend_test_files=("bot/tests/test_dashboard_routes_v3.py",),
        dashboard_test_files=("dashboard/tests/api_contract_parity.test.js",),
    ...
    ParityContractEntry(
        ...
        dashboard_surface="clips_section",
        status="integrated",
        dashboard_route_prefix="/api/vision/ingest",
        backend_test_files=(
            "bot/tests/test_dashboard_routes_post.py",
            "bot/tests/test_dashboard_routes_v2.py",
        ),
    ...
    ParityContractEntry(
        method="GET",
        backend_route="/api/webhooks",
        domain="control_plane",
        dashboard_surface="control_plane",
        status="integrated",
        dashboard_route_prefix="/api/webhooks",
        backend_test_files=("bot/tests/test_dashboard_routes_v3.py",),
        dashboard_test_files=("dashboard/tests/api_contract_parity.test.js",),
        route_snippet="/api/webhooks",
    ),
    ParityContractEntry(
        method="PUT",
        backend_route="/api/webhooks",
    ...
    ParityContractEntry(
        method="POST",
        backend_route="/api/webhooks/test",
        domain="control_plane",
        dashboard_surface="control_plane",
        status="integrated",
        dashboard_route_prefix="/api/webhooks/test",
        backend_test_files=("bot/tests/test_dashboard_routes_post.py",),
        dashboard_test_files=("dashboard/tests/api_contract_parity.test.js",),
