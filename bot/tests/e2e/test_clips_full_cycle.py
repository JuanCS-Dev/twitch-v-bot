...
class TestE2EClipsPipeline(unittest.TestCase):
    ...
    def test_e2e_happy_path_live_clip(self):
        ...
        with patch("bot.autonomy_logic.generate_goal_text", return_value="Momentazo épico aconteceu"):
    ...
    def test_e2e_persistence_rehydration(self):
        ...
        active_jobs = [
            {
                "job_id": "j1", "action_id": "a1", "status": "polling", 
                "twitch_clip_id": "c1", "created_at": "2023-01-01",
                "broadcaster_id": "999", "next_poll_at": 0.0, "poll_until": 9999999999.0
            },
            {
                "job_id": "j2", "action_id": "a2", "status": "queued", 
                "created_at": "2023-01-02", "broadcaster_id": "999", "mode": "live"
            }
        ]
