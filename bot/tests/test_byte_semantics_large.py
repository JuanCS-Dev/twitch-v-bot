...
class TestByteSemanticsLargeFiles(unittest.TestCase):
    def test_quality_functions(self):
        ...
        # Anti-generic
        self.assertIn("Contrato anti-generico", quality.build_anti_generic_contract_instruction("Pergunta"))
    ...
    def test_events_utility(self):
        ...
        self.assertIn("2026-01-01", events.build_server_time_anchor_instruction("2026-01-01T00:00:00Z"))
