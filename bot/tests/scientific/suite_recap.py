...
class ScientificRecapTestsMixin(ScientificTestCase):
    """Testes cientificos para RecapEngine (Fase 9)."""

    def test_recap_pattern_o_que_ta_rolando(self) -> None:
    ...
    @patch("bot.recap_engine.agent_inference")
    def test_recap_generate_empty_returns_fallback(self, mock_inference: AsyncMock) -> None:
        from bot.recap_engine import generate_recap
    ...
    def test_recap_prompt_runtime_intercept(self, mock_recap: AsyncMock) -> None:
