...
is_ascii_art_prompt = byte_semantics.is_ascii_art_prompt
extract_ascii_subject = byte_semantics.extract_ascii_subject
...
def build_prompt_runtime(ctx: Any = None) -> BytePromptRuntime:
    ...
    return BytePromptRuntime(
        ...
        is_ascii_art_prompt=is_ascii_art_prompt,
        extract_ascii_subject=extract_ascii_subject,
